...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'infobip_kafka_service.clickhouse_helpers': { 'infobip_kafka_service.clickhouse_helpers._create_clickhouse_connection_string': ( 'clickhouse_helpers.html#_create_clickhouse_connection_string',
                                                          ...
                                                          'infobip_kafka_service.clickhouse_helpers.get_unique_account_ids_model_ids': ( 'clickhouse_helpers.html#get_unique_account_ids_model_ids',
                                                                                                                                         'infobip_kafka_service/clickhouse_helpers.py')},
            'infobip_kafka_service.downloading': { 'infobip_kafka_service.downloading.get_clickhouse_params_from_env_vars': ( 'downloading.html#get_clickhouse_params_from_env_vars',
